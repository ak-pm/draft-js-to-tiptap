...
interface NodeMapping {
    ...
    codeBlock: NodeType<"codeBlock", Record<string, any>, MarkType, NodeMapping["text"][]>;
    hardBreak: NodeType<"hardBreak">;
    heading: NodeType<"heading", {
        level: number;
    }, MarkType, NodeMapping["inline"][]>;
    ...
    paragraph: NodeType<"paragraph", Record<string, any>, MarkType, NodeMapping["inline"][]>;
    tableCell: Omit<NodeType<"tableCell", {
        colwidth?: number[];
        colspan?: number;
        rowspan?: number;
    }>, "content"> & {
    ...
    tableHeader: Omit<NodeType<"tableHeader", {
        colwidth?: number[];
        colspan?: number;
        rowspan?: number;
    }>, 'content'> & {
    ...
    tableRow: NodeType<"tableRow", Record<string, any>, MarkType, NodeMapping["tableCell" | "tableHeader"][]>;
    table: NodeType<"table", Record<string, any>, MarkType, NodeMapping["tableRow"][]>;
    taskItem: Omit<NodeType<"taskItem", {
        checked?: boolean;
    }>, 'content'> & {
        content: NodeMapping["block"][];
    };
...
type AnyNodeType = NodeType<string, Record<string, any>, MarkType, AnyNodeType[]>;
type NodeType<TNodeType extends string = string, TNodeAttributes extends Record<string, any> = Record<string, any>, TMarkType extends MarkType = MarkType, TContentType extends AnyNodeType[] = never> = {
    type: TNodeType;
    attrs?: TNodeAttributes & Record<string, any>;
    marks?: TMarkType[];
    content?: TContentType;
};
type DocumentType<TNodeAttributes extends Record<string, any> = Record<string, any>, TContentType extends AnyNodeType[] = NodeMapping["block"][]> = NodeType<"doc", TNodeAttributes, never, TContentType>;
 ...
 */
declare function addChild<TNodeType extends keyof NodeMapping>(node: NodeMapping[TNodeType] & {
    type: TNodeType;
}, child: NodeMapping[TNodeType]["content"] | NonNullable<NodeMapping[TNodeType]["content"]>[number] | null): NodeMapping[TNodeType];
/**
 ...
 */
declare function isListNode(node: AnyNodeType | null | undefined): node is NodeMapping["bulletList"] | NodeMapping["orderedList"] | NodeMapping["taskList"];
...
declare class DraftConverter {
    ...
    convert(draft: RawDraftContentState): DocumentType<Record<string, any>, ((Omit<NodeType<"blockquote", Record<string, any>, MarkType<string, Record<string, any>>, never>, "content"> & {
        content: NodeMapping["block"][];
    }) | NodeType<"bulletList", Record<string, any>, MarkType<string, Record<string, any>>, (Omit<NodeType<"listItem", Record<string, any>, MarkType<string, Record<string, any>>, never>, "content"> & {
        content: NodeMapping["block"][];
    })[]> | NodeType<"codeBlock", Record<string, any>, MarkType<string, Record<string, any>>, (NodeType<"text", Record<string, any>, MarkType<string, Record<string, any>>, never> & TextType<MarkType<string, Record<string, any>>>)[]> | NodeType<"heading", {
        level: number;
    }, MarkType<string, Record<string, any>>, ((NodeType<"text", Record<string, any>, MarkType<string, Record<string, any>>, never> & TextType<MarkType<string, Record<string, any>>>) | NodeType<"hardBreak", Record<string, any>, MarkType<string, Record<string, any>>, never>)[]> | NodeType<"paragraph", Record<string, any>, MarkType<string, Record<string, any>>, ((NodeType<"text", Record<string, any>, MarkType<string, Record<string, any>>, never> & TextType<MarkType<string, Record<string, any>>>) | NodeType<"hardBreak", Record<string, any>, MarkType<string, Record<string, any>>, never>)[]> | NodeType<"taskList", Record<string, any>, MarkType<string, Record<string, any>>, (Omit<NodeType<"taskItem", {
        checked?: boolean;
    }, MarkType<string, Record<string, any>>, never>, "content"> & {
        content: NodeMapping["block"][];
    })[]> | NodeType<"orderedList", {
        type?: "1" | "a" | "A" | "i" | "I";
        start?: number;
    }, MarkType<string, Record<string, any>>, (Omit<NodeType<"listItem", Record<string, any>, MarkType<string, Record<string, any>>, never>, "content"> & {
        content: NodeMapping["block"][];
    })[]> | NodeType<"table", Record<string, any>, MarkType<string, Record<string, any>>, NodeType<"tableRow", Record<string, any>, MarkType<string, Record<string, any>>, ((Omit<NodeType<"tableCell", {
        colwidth?: number[];
        colspan?: number;
        rowspan?: number;
    }, MarkType<string, Record<string, any>>, never>, "content"> & {
        content: NodeMapping["block"][];
    }) | (Omit<NodeType<"tableHeader", {
        colwidth?: number[];
        colspan?: number;
        rowspan?: number;
    }, MarkType<string, Record<string, any>>, never>, "content"> & {
        content: NodeMapping["block"][];
    }))[]>[]> | NodeType<"horizontalRule", Record<string, any>, MarkType<string, Record<string, any>>, never> | NodeType<"image", {
        src: string;
        alt?: string;
    }, MarkType<string, Record<string, any>>, never>)[]>;
}
